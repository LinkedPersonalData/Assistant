 ...
 * {@link PlaceDetailActivity} representing item details. On tablets, the
 * activity presents the list of items and item details side-by-side using two
 * vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link PlaceListFragment} and the item details (if present) is a
 * {@link PlaceDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link PlaceListFragment.Callbacks} interface to listen for item selections.
 */
public class PlaceListActivity extends FragmentActivity implements
	...
	public void onItemSelected(SuggestedPlace suggestedPlace) {
		if (mTwoPane) {
			...
			arguments.putString(WebViewFragment.ARG_URL, suggestedPlace.getUri());
			...
			detailIntent.putExtra(WebViewFragment.ARG_URL, suggestedPlace.getUri());
